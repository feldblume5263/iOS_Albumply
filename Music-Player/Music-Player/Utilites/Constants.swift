...
let mainTextColor = Color(red: 72/255, green: 180/255, blue: 224/255)
let mainColor = Color(red: 130/255, green: 200/255, blue: 227/255)
let subColor = Color(red: 218/255, green: 239/255, blue: 248/255)

let libraryAlbumTitleFontColor = Color.black
let libraryAlbumArtistFontColor = Color.gray
